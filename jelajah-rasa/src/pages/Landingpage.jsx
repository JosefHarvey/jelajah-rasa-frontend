    ...
    return(
        <>
            <div className="capitalize relative flex flex-col items-center ">
                ...
                <div className="uppercase absolute bottom-3 text-white text-lg font-semibold font-Lora border-b-2 border-[#D71515] md:bottom-15 md:text-2xl lg:bottom-30 lg:text-3xl">jelajahi peta</div>
                
            </div>

            <div className="my-5 mx-2 md:mx-10 md:my-5 lg:mx-20 lg:my-10">
                <div className="flex flex-col  text-[#4A3521] items-start md:w-full lg:w-290">
                    ...
                    <a href="" className="hidden font-Montserrat text-sm/4 mt-1 md:text-xl md:block">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat...</a>
                    <a className="inline-block font-Montserrat mt-2 uppercase text-base border-b-2 border-[#D71515] font-medium w-60 md:hidden">baca selengkapnya</a>
                ...
                <div className="w-full m-2 flex flex-nowrap overflow-x-auto gap-20 md:justify-evenly md:my-10">
                    <a href="" className="flex flex-col items-center justify-center w-80 my-4 flex-shrink-0">
